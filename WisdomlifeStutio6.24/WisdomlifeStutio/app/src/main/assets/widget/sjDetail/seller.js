	       ...
	       if (data.formDataset.checked == 'true') {
	       		...
	       		if(list.length==undefined ||list.length==0 ||list==undefined || list=='' || list.length  ==''){
		       		...
		       		for(var i=0;i<list.length;i++){
						...
						var nowli='<div class="conmment-neirong">'
								+'<span class="showPic"><img src="'+rootUrl+list[i].head_image+'" alt="" /></span>'
		   						+'<span>'
		   						+'<div>'+list[i].user_no+''
			   					+'</div>'
			   					+'<div><span class="dafen">打分</span>'
			   					+''+starLenght(starlen)+''
			   					+'<div class="cl"></div>'
			   					+'</div>'
			   					+'</span>'
		   						+'<span class="youzhi">'+time[0]+'</span>'
		   						+'<div class="cl"></div></div>'
		   						+'<div class="conmment-jianjie"><span>'+list[i].content+'</span></div>'
	   							+'<div class="conmment-ps">'
	   							+''+pic(picLen)+''
	   							+'<div class="cl"></div>'
	   							+'</div>'
	   							+'<div class="conmment-pl" style="border-bottom:1px solid #EAEAEA; height: 12px;width: 100%"></div>'
