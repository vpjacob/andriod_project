        ...
        ************   Pages   ************
        ...
        app.pageAnimCallback = function (callback, view, params) {
            ...
            if (callback === 'after') {
                ...
                if($(pageContainer).attr('only-page')) $("[data-page='"+params.fromPage.name+"']").remove();
                ...
                m.container.find('.message').each(function () {
                    ...
                    if (message.find('.message-text img').length > 0) {
                        ...
                        for (var i = 0 ; i < childNodes.length; i++) {
                            if (childNodes[i].nodeType === 1 && childNodes[i].nodeName.toLowerCase() !== 'img' || (childNodes[i].dataset && childNodes[i].dataset.type == 'em') ) onlyPic = false;
                            if (childNodes[i].nodeType === 3 && childNodes[i].textContent.trim() !== '' || (childNodes[i].dataset && childNodes[i].dataset.type == 'em') ) onlyPic = false;
                        }
